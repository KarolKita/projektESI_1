...
# gdzie w pierwszej kolumnie sa atrybuty
# w drugiej kolumnie sa przeslanki
...
for nr_wiersza in range(1, ilo_wierszy+1):
    ...
    # wczytanie przypadkow dla danej przeslanki (czyli '0' oraz '1')
...
for atrybut in tablica:
    print(atrybut, ": ")
    for przeslanka in tablica[atrybut]:
        print("     ", przeslanka, ": ", end=" ")
        print(tablica[atrybut][przeslanka])
